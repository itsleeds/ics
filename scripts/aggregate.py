...
for r in records:
    rows.append({
        ...
        "n_mentions_pct": to_num(r.get("n_mentions_pct")),
        "pct_term_breakdown": json.dumps(r.get("pct_term_breakdown")) if isinstance(r.get("pct_term_breakdown"), dict) else r.get("pct_term_breakdown"),
        "n_screenshots_pct": to_num(r.get("n_screenshots_pct")),
        "pct_usage_depth": r.get("pct_usage_depth"),
        "has_text_layer": to_bool(r.get("has_text_layer")),
